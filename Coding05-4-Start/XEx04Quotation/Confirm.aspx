<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Confirm.aspx.cs" Inherits="Coding0504.Confirm" %>
<!--<%@ PreviousPageType VirtualPath="~/XEx04Quotation/Default.aspx" %> -->
...
<body>
    <form id="form1" runat="server" class="form-horizontal">
        ...
        <main class="container">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtName" 
                        Display="Dynamic" ErrorMessage="Required" CssClass="text-danger" ValidationGroup="SendQuotationGrp"></asp:RequiredFieldValidator>
                </div>  
            </div>  
            ...
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-9">
                    <%-- buttons go here --%>
                    <asp:Button ID="btnSendQuote" runat="server" CssClass="btn btn-primary" Text="Send Quotation" OnClick="btnSendQuote_Click" ValidationGroup="SendQuotationGrp"  />
                    <asp:Button ID="Button2" runat="server" CausesValidation="False" CssClass="btn btn-primary" Text="Return" PostBackUrl="~/XEx04Quotation/Default.aspx" />
                </div>
            </div> 
        ...
        <asp:Label ID="lblQuotation" runat="server" CssClass="text-info"></asp:Label>
